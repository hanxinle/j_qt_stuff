...
public:
    ...
    ConcreteProduct *DoCreate(Type2Type<AbstractProduct>) { return new ConcreteProduct; }
};
...
public:
    ...
    friend void DoSetPrototype(PrototypeFactoryUnit &me, AbstractProduct *pObj) { me.pPrototype_ = pObj; }
...
template <
    class AbstractFact, template <class, class> class Creator = OpNewFactoryUnit,
